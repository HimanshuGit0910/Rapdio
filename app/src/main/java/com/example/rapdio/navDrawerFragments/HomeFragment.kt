...
import com.example.rapdio.Activity.LetsCelebrate
import com.example.rapdio.Activity.RiderArrived
import com.example.rapdio.DataParser.DataParser
import com.example.rapdio.Location.LocationViewModel
import com.example.rapdio.R
import com.example.rapdio.fragments.BottomSheetFragment
import com.example.rapdio.viewModel.AfterClickingRideNow
import com.example.rapdio.viewModel.DistanceViewModel
...
//        NotificationManagerCompat.from(requireContext()).cancelAll()
    ...
    private fun askForPermission() {
        askPermission(
            ...
            if (e.hasForeverDenied()) e.foreverDenied.forEach1 {
                e.goToSettings()
            }
        }
    }
